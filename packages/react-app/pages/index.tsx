...
export default function Home() {
    ...
    useEffect(() => {
        const fetchRecentTransactions = async () => {
            if (address) {
                try {
                    const response = await axios.get(`/api/recent-transactions?userAddress=${address}`);
    ...
    return ( <div className="flex flex-col max-w-sm p-3 space-y-4 bg-gray-200 shadow-3xl shadow-black/50 font-harmony">
            <div className="w-full max-w-sm px-6 py-2 mt-1 bg-white shadow-xl rounded-3xl">
            ...
            <div className="flex items-center justify-between mt-4">
                ...
                <>
                    {tx && (
                        <p className="mt-4 font-bold text-center text-green-600 break-words">
                             Tx Completed:{" "}
